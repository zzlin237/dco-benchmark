...
dataset_path="/home/zzlin/dataset/${dataset}/train_${size}/Qgist_base.fvecs"
index_path="/home/zzlin/dataset/${dataset}/train_${size}/tmp_Q${dataset}_M16_efConstruction500_operator0.index"
