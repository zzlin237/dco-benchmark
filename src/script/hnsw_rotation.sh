...
index_path="/home/zzlin/dataset/${dataset}/hnsw_norm_${dataset}_M16_efConstruction500_operator8.index"
#index_new_path="/home/zzlin/dataset/${dataset}/hnsw_${rotation}${dataset}_M16_efConstruction500_operator0.index"
index_new_path="/home/zzlin/dataset/${dataset}/hnsw_norm_${rotation}${dataset}_M16_efConstruction500_operator8.index"
