...
operator=2                                                        #**
index_path="/home/zzlin/dataset/${dataset}/ivf_${dataset}_C4096_operator0.index"
index_new_path="/home/zzlin/dataset/${dataset}/ivf_${rotation}${dataset}_C4096_operator0.index"
