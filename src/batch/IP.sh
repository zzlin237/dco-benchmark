...
for data in {0..4}; do
  for op in {0..7}; do
    ...
    ground_truth_path="/home/zzlin/dataset/${datasets[$data]}/${truth[$data]}"
    index_path="/home/zzlin/dataset/${datasets[$data]}/hnsw_${norm[$op]}${rotate[$op]}${datasets[$data]}_M16_efConstruction500_operator8.index"
