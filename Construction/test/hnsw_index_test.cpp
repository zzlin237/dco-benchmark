...
int main(int argc, char *argv[]) {
    ...
    std::string dataset_path = "/home/zzlin/dataset/trevi/Ltrevi_base.fvecs";
    std::string index_path = "/home/zzlin/dataset/trevi/hnsw_Ltrevi_M16_efConstruction500_operator0.index";
    int M = 16;
