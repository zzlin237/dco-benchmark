...
int main(int argc, char **argv) {
    ...
    std::string ground_truth_path = "/home/zzlin/dataset/wiki/gt_256_ip.ivecs";
    std::string index_path = "/home/zzlin/dataset/wiki/hnsw_wiki_M16_efConstruction500_operator8.index";
    std::string output_path = "/home/zzlin/dataset/wiki/ddc/wiki_hnsw_pca_100_training_set_ip.fvecs";
    std::string linear_path = "/home/zzlin/dataset/wiki/ddc/linear_hnsw100_pca_ip.txt";
    double recall = 0.995;
